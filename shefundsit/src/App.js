            ...
            >
              ...
              >
                ...
                <div style={{ display: mainTabValue === 0 ? "block" : "none" }}>
                  ...
                  <div>
                    {subTabValue === 0 && <p>Content for SubTab 1</p>}{" "}
                    {/* Example content for SubTab 1 */}
                    {subTabValue === 1 && <MyStatus />}{" "}
                    {/* Render MyStatus component when subTabValue is 0 */}
                  </div>
                </div>
                <div style={{ display: mainTabValue === 1 ? "block" : "none" }}>
                  <p>Main Tab 2 Content</p>
                  <div>
                    {subTabValue === 0 && <p>Content for SubTab 2</p>}{" "}
                    {/* Example content for SubTab 2 */}
                    {subTabValue === 1 && <p>Content for SubTab 2</p>}{" "}
                    {/* Example content for SubTab 2 */}
                  </div>
                </div>
                {quizStarted ? (
